...
先按`skills/story-video-craft/SKILL.md`选择人物、组织／项目或危机／群像分支，建立故事合同、因果台账与信息释放图；再按`skills/write-capital-story/SKILL.md`写架构稿和口播稿。章节默认由唯一承载者的连续选择或状态变化推进，不按机构或金融术语分类。每章至少回答：
